...
class LiveStreamControllerTest {
    ...
    void create() {
        ...
        LiveStream stream = new LiveStream(
                ...
                LocalDateTime.of(2022,3, 1,11,0),
        ...
        assertEquals(LocalDateTime.of(2022,3, 1,11,0),newStream.startDate());
        assertEquals(LocalDateTime.of(2022,3, 1,12,0),newStream.endDate());
    }
