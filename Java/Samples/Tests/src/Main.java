public class Main {
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBucket) {
        ...
        double areaHave = areaPerBucket * extraBucket;
        double areaNeed = area - areaHave;
        int bucketNeed = (areaNeed > 0) ? (int) (areaNeed / areaPerBucket) + 1 : 0;
        return bucketNeed;
    }
    ...
    public static int getBucketCount (double width, double height, double areaPerBucket) {
        ...
        double area = width * height;
        int bucketNeed = (area > 0) ? (int) (area / areaPerBucket) + 1 : 0;
        return bucketNeed;
    }
